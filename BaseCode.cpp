...
void retrato()
    {
        ...
        for(int y = 0; y < height; y++)
        {
            ...
            {
                int value = (Lattice[y][x].density()*255)/N;
                int r = 0;
                int g = 0;
    ...
    void retrato_2()
    {
        ...
        for(int y = 0; y < height; y++)
        {
            ...
            {
                int b,r,g;
                if(Lattice[y][x].preferS())
                {
                    b = (Lattice[y][x].density()*255)/N;
                    r = 0;
                    g = 0;
                }
                else
...
int main()
{
    ...
    vector<int> info;
    LGCA B = LGCA(100, 10, 4, 4, 0.8, 3, 0.2, 0.25);
    B.putstrip();
    //Damos un paso de 200 unidades de tiempo
    B.walk(1500);

    //B.retrato();
    
    B.retrato_2();
    //Registramos lo que paso
    info = B.bulk_info();
